		...
		<div className="grid grid-cols-3">
			<div className="pb-6">
				<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                    ...
                    <p className='w-[70%]'>When do they work well, and when do they on us and finally, when do we actually need how can we avoid them.</p>
			</div>
			...
			<div className="flex gap-8 -translate-x-40">
				<h1 className='text-9xl bg-gradient-to-r from-primary via-[#c9f31d] to-secondary text-transparent bg-clip-text animate-gradient bg-300%'>LET'S {' '}</h1>
				<h1 className='text-9xl bg-gradient-to-r from-primary via-[#f9d371] to-secondary text-transparent bg-clip-text animate-gradient bg-300%'>{' '} TALK</h1>
