      ...
      <div className=" p-10 ml-20 ">
        ...
        <div className="flex items-start justify-between gap-24">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-6">
            <div className="py-6 px-8 rounded-lg bg-[#121212] text-white">
              <div className="flex justify-between">
                <div>
                  <h2 className="text-lg font-medium mb-2">Lifetime</h2>
                  <p className="text-sm">Access forever</p>
                </div>
                <div className="text-4xl">$349</div>
              </div>
              <div className="border-b border-gray-600 my-6"></div>
              <ul className="text-sm space-y-4">
                <li>One payment, access forever</li>
                <li>All features and benefits</li>
              </ul>
            </div>
            <div className="py-6 px-8 rounded-lg bg-white text-black">
              <div className="flex justify-between">
                <div>
          ...
          <a
            href="#"
            className="relative flex items-center justify-center w-[150px] h-[150px] text-black border border-black rounded-full overflow-hidden p-20 transition-all duration-300 group"
          >
            ...
            <span className="relative z-10 flex items-center text-black group-hover:text-white">
              Try It FreeNow <MdArrowOutward size={35} className="ml-2" />
            </span>
          </a>
        </div>
          </div>
